...
| Файл | Что показывает |
|------|----------------|
| `Код.jpg` | Код функции `privetstvie()` с PHPDoc-комментариями и строчными комментариями |
| `Приветствие.jpg` | Работа шорткода `[приветствие]` на главной странице сайта |
